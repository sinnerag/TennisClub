...
class Datepicker extends JDialog {
    ...
    public Datepicker() {
        ...
        d.pack();
        d.setLocationRelativeTo(Reservations_Details.jPanel1);
        displayDate();
        d.setVisible(true);
    }
...
//}         
    ...
    public static void datepicker() {
        Reservations_Details.jPanel1.add(Reservations_Details.jTextField4);
        Reservations_Details.jTextField4.setText(new Datepicker().setPickedDate());
    }
}
